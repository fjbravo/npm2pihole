...
SFTPIP=192.168.10.2
IP=192.168.10.81
NPM_ProxyHost="/data/nginx/proxy_host"
...
main() {
    ...
    for file in $NPM_ProxyHost/*; do dlist1+=("$(grep "server_name" "$file" | sed "s/  server_name //; s/;//")"); done
...
while true; do
    main
    echo sleeping
    inotifywait -e modify,create,attrib $NPM_ProxyHost
done
